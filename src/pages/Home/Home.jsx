...
export default function Home() {
    ...
    return<>
        <div className={style.container}>
            ...
            <div className={'w-full flex max-[650px]:flex-col max-[650px]:gap-4 items-center justify-between max-[650px]:-translate-y-[50px] -translate-y-16 pl-32 max-[730px]:px-4 max-[1200px]:pr-10 max-[1200px]:pl-20 min-[1800px]:pl-80 pr-16'}>
                ...
                <div data-aos="fade-right" className={'flex flex-col max-[650px]:items-center relative'}>
                    ...
                    <div className={` ${style.shadow_inner} w-[450px] max-[1000px]:w-[350px] max-[650px]:w-[280px] max-[1000px]:h-24 h-32 bg-white flex items-center  rounded-2xl`}>
                ...
                <div data-aos="fade-left" className={` ${style.shadow_inner} max-[1000px]:w-60  max-[1000px]:h-24 w-80 h-32 px-4 bg-white flex items-center justify-center  rounded-2xl`}>
