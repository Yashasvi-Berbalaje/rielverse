            ...
            <div className={'w-full h-auto flex flex-col items-start bg-gradient-to-b from-white to-white/30 px-5 pt-3 pb-20 rounded-t-xl text-start'}>
                ...
                <div className={'flex items-start flex-wrap gap-10 mt-7 '}>
                    ...
                    <div className={'h-[130px] max-[500px]:h-auto justify-between flex flex-col items-start text-start'}>
                        ...
                        <input style={{fontFamily:"Arboria-Light",fontWeight:"400"}} placeholder={'086 - 594030302'} className={' max-[500px]:w-[190px] w-[260px] h-[50px] rounded-xl outline-0 border shadow-inner pl-12 border-[#8DC14B]'}/>
                    </div>
