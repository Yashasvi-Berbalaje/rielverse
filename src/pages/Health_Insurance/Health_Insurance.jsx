...
import operator from "../../Reilverse_Assets/operator.svg";
import call from "../../Reilverse_Assets/support call.svg";
import mail from "../../Reilverse_Assets/mail.svg";
                ...
                <div className={'w-full h-auto bg-gradient-to-b from-[#8DC14B] to-transparent p-[1px] rounded-t-xl'}>
                    ...
                    <div className={'w-full h-auto flex max-[700px]:flex-col max-[700px]:items-center items-start bg-gradient-to-b from-white/90 to-white/30 rounded-t-xl gap-10 px-5 pt-3 pb-20'}>
                        ...
                        <div className={'flex flex-col items-start text-start max-w-[600px]'}>
                            ...
                            <div className={'overflow-hidden w-[150px] h-10 flex pl-7 max-[630px]:text-start items-center self-start rounded-lg text-[16px] text-white font-semibold bg-gradient-to-tl from-[#93c347] to-[#b8cf29] relative mt-7'}>
                        ...
                        <div className={'w-[1px] h-[350px] max-[700px]:hidden bg-gradient-to-b from-[#8DC14B] to-transparent mt-10'}></div>
                        ...
                        <div className={'flex flex-col items-start text-start gap-4 mt-10'}>
                            ...
                            <div className={'flex items-center gap-3'}>
                                ...
                                <div className={'flex flex-col items-start text-start'}>
                                    ...
                                    <span className={'text-[16px] text-[#47740E]'}>Drop Email At</span>
