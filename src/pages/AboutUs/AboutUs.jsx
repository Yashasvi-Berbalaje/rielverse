        ...
        <div className={style.container}>
            ...
            <div className={'w-full max-[520px]:px-4 max-[1200px]:px-10 max-[1300px]:max-w-[1150px] max-w-[1200px] min-[1600px]:max-w-[1400px] min-[1800px]:max-w-[1600px] h-auto flex flex-col items-center pb-20'}>
                ...
                <div className={'w-full h-auto bg-gradient-to-b from-[#8DC14B] to-transparent p-[1px] rounded-t-xl'}>
                    ...
                    <div className={'w-full h-auto flex flex-col items-start bg-gradient-to-b from-white/90 to-white/30 rounded-t-xl gap-10 px-10 pt-8 pb-20'}>
                        ...
                        <div className={'w-full flex flex-col items-start text-start'}>
                            ...
                            <span className={'text-[24px] max-w-[550px]'}>Comparing, customizing & buying insurance policies has just got easier</span>

                            <span style={{fontFamily:`Arboria-Book`,fontWeight:`400`}} className={'text-[18px]  mt-5'}>
                                Rielverse is built on over a decade’s worth of insurance experience and expertise. Abc, our co-founder has worked in insurance for nearly 15 years, and understands the pain points of the customers who are looking to buy or renew their insurance, be it car, home, life or health and has been looking at how to resolve these issues as well as providing a solution-based service to his clients.<br/><br/>
                                This is where Abc, founder of SNG and co-founder of Rielverse was able to provide his digital experience to help build a user friendly and easy digital platform that provides an online quote to customers in under 1 minute, at any time, anywhere on any device.
                            </span>
                        ...
                        <div className={'w-full flex items-start gap-10 '}>
                            ...
                            <div className={'w-[300px] h-[450px]'}>
                                <div className={'w-[300px] h-[448px] block border-2 rounded-xl overflow-visible border-[#8DC14B]/50 hover:border-[#8DC14B] p-[1px] duration-300'}>
                                    ...
                                    <img className={'w-[297px] h-[445px] object-contain rounded-xl duration-300 shadow-xl hover:shadow-[#8DC14B]/30 translate-x-1 translate-y-1 hover:translate-x-3 hover:translate-y-3'} src={layer} alt={'back layer'}/>
                            ...
                            <div className={'flex flex-col items-start text-start mt-7 '}>
                                ...
                                <span className={'text-[24px] max-w-[550px]'}>Our Mission</span>

                                <span style={{fontFamily:`Arboria-Book`,fontWeight:`400`}} className={'text-[18px]  mt-5'}>
                                    Our mission is to become the most reliable platform for personal finance and insurance in the SNG by simplifying the process. Find and compare insurance policies, credit cards, loans, and bank accounts all in one place.
                                </span>


                                <span className={'text-[24px] max-w-[550px] mt-7'}>Our Vision</span>

                                <span style={{fontFamily:`Arboria-Book`,fontWeight:`400`}} className={'text-[18px]  mt-5'}>
                                    Our vision is to have you bank on us for all your personal finance needs. Our platform allows you to easily compare multiple policies side-by-side to visualize the benefits and advantages of each policy, thereby empowering you to make your own informed banking decisions.
                                </span>
                        ...
                        <p style={{fontFamily:`Arboria-Book`,fontWeight:`400`}} className={'text-start'}>
                            The team at Rielverse has been hand-picked to ensure that the same level of care, service and insurance expertise is what each customer receives, always! Constantly listening and learning so that the customer has the best digital experience, is able to find the best insurance cover quickly, easily and at the best price with an insurance expert at the other end of the phone or WhatsApp chat as support.<br/><br/>
                            The team at Rielverse chose to partner with Abc Insurance as their broker because they have nearly 15 years of experience within the insurance industry, and more importantly they provide a service that aligns itself with the values that underpin Rielverse around quality, transparency, speed, and best service.
                        </p>
