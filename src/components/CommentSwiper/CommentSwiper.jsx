...
export default function CommentSwiper() {
    ...
    return<>
        <div className={'w-full max-w-[850px] h-72 relative mt-7'}>
            <div className={'flex items-center  w-16 h-16 flex items-center justify-center rounded-lg bg-[#8dc14b]/30 gap-2 absolute top-0 max-[500px]:right-4 right-28 z-10'}>
